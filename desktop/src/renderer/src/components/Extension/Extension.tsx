...
export function Extension() {
    ...
    return (
        <div className="flex-1 flex items-start justify-center pt-4 sm:pt-6  px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#fffde5' }}>
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 lg:gap-8 max-w-3xl w-full">
                ...
                <div className="flex flex-col gap-2 sm:gap-3 text-center sm:text-left w-full">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 leading-relaxed max-w-md mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>
                        Preceptor uses a browser extension to get the current tab name from your browser and pass it to local AI.
                    </p>
                    <ExtensionStatus />
                    {isExtensionActive === false && <StoreButtons />}
                </div>
            </div>
        </div>
    );
